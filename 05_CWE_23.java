...
//
// URL:
// https://github.com/mustafaasif1/WebGoat/blob/9c90a24cc06452bda60c259a19862d8b7bf33c3e/src/main/java/org/owasp/webgoat/lessons/pathtraversal/ProfileUploadRetrieval.java#L102
//
// Vulnerabilty in line: 102, 104, 108, 113
// 
// Extra Context:
// Line 102:  Unsanitized input from an HTTP parameter flows into org.springframework.util.FileCopyUtils.copyToByteArray, where it is used as a path. This may result in a 
// Path Traversal vulnerability and allow an attacker to read arbitrary files.
//
// Line 104: Unsanitized input from an HTTP parameter flows into exists, where it is used as a path. This may result in a Path Traversal vulnerability and allow an attacker to bypass 
// the logic of the application in the conditional expression.
//
// Line 108: Unsanitized input from an HTTP parameter flows into org.springframework.util.FileCopyUtils.copyToByteArray, where it is used as a path. This may result in a Path 
// Traversal vulnerability and allow an attacker to read arbitrary files.
//  
// Line 113: Unsanitized input from an HTTP parameter flows into listFiles, where it is used as a path. This may result in a Path Traversal vulnerability and allow an attacker 
